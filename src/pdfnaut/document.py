...
from typing import Any, cast, Generator, overload, TypeVar
...
from .cos.objects import (PdfReference, PdfObject, PdfName, PdfStream, PdfHexString,
                          PdfXRefEntry, PdfArray, PdfDictionary)
...
class PdfDocument:
    ...
    @overload
    def get_object(self, reference: tuple[int, int], cache: bool = True) -> PdfObject | PdfStream:
        ...
    
    def get_object(self, reference: PdfReference | tuple[int, int], cache: bool = True) -> PdfObject | PdfStream | Any:
